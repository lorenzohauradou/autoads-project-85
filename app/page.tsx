                    ...
                    <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 max-w-7xl mx-auto">
                        ...
                        <div className="space-y-4">
                            <div className="aspect-square bg-gradient-to-br from-slate-50 to-slate-100 rounded-2xl overflow-hidden shadow-sm">
                                <Image
                                    src="https://beasahuotuicaipswzhe.supabase.co/storage/v1/object/public/uploads/d7fded15-fad9-4f1b-b7ac-354cac950e8b.jpg?"
                            ...
                            <div className="grid grid-cols-4 gap-3">
                                {[
                                    { src: "https://beasahuotuicaipswzhe.supabase.co/storage/v1/object/public/uploads/b2f94127-5c2e-4142-9cb4-6374762a1d8c.jpg?", alt: "MAVEE Elite Electric Scooter - Side view" },
                                    { src: "https://beasahuotuicaipswzhe.supabase.co/storage/v1/object/public/uploads/c8df79a8-d1a5-4fd7-ac50-65e9e938ca6c.jpg?", alt: "MAVEE Elite Electric Scooter - Dashboard" },
                                    { src: "https://beasahuotuicaipswzhe.supabase.co/storage/v1/object/public/uploads/173f19e0-c400-43de-a3e4-88cdb6b8cd44.jpg?", alt: "MAVEE Elite Electric Scooter - Folded" },
                                    { src: "https://beasahuotuicaipswzhe.supabase.co/storage/v1/object/public/uploads/1bfd9fae-ed85-4bdb-b5f2-f42e10c38938.jpg?", alt: "MAVEE Elite Electric Scooter - Details" },
                                ].map((image, i) => (
                                    <div
                                        key={i}
                        ...
                        <div className="space-y-6 lg:space-y-8">
                            <div className="space-y-4">
                                ...
                                <p className="text-lg text-slate-600 leading-relaxed max-w-lg">
                                    Transform your daily journey with premium performance. 60km range, smart energy recovery, and three-speed control for the ultimate urban mobility experience.
                                </p>
                            </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <p className="text-sm font-medium text-green-600 flex items-center gap-2">
                                    ...
                                    In stock - Ships within 24 hours + Free Premium Charger
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                {[
                                    ...
                                    { icon: Gauge, text: "25km/h Top Speed" },
                            ...
                            <div className="grid grid-cols-3 gap-4 pt-6 border-t border-slate-200">
                                ...
                                <div className="text-center space-y-2">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-500">Premium support</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <TabsContent value="features" className="mt-8">
                                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
                                            ...
                                            {[
                                                {
                                                    ...
                                                    description: "60km on a single charge with 477.36Wh lithium battery",
                                                },
                                                {
                                                    title: "Smart Energy Recovery",
                                                    description: "Recaptures 15% of power during braking for extended rides",
                                                },
                                                {
                                                    title: "Three-Speed Control",
                                                    description: "Customize your ride with versatile speed settings up to 25km/h",
                                                },
                                                {
                                                    title: "Premium Build Quality",
                                                    description: "Sophisticated matte black design with durable construction",
                                                },
                                            ].map((feature, i) => (
                                    ...
                                    <div className="aspect-video bg-white rounded-2xl shadow-sm overflow-hidden flex items-center justify-center">
                                        <Image
                                            src="https://beasahuotuicaipswzhe.supabase.co/storage/v1/object/public/uploads/b2f94127-5c2e-4142-9cb4-6374762a1d8c.jpg?"
                                            alt="MAVEE Elite Electric Scooter features demonstration"
                                            width={480}
                                            height={360}
                                            className="w-full h-full object-cover"
                                        />
                                    ...
                                    <Card className="shadow-sm border-0">
                                        ...
                                        <CardContent className="space-y-4">
                                            {[
                                                ...
                                                { label: "Energy Recovery", value: "15% regenerative braking" },
                                                { label: "Speed Modes", value: "3 settings" },
                                                { label: "Frame", value: "Aerospace-grade aluminum" },
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="bg-white rounded-2xl p-6 shadow-sm space-y-4">
                                            {[
                                                ...
                                                "1x Premium Fast Charger (FREE)",
                                                "1x User Manual",
                                                "1x Tool Kit",
                                                "1x 2-Year Warranty Card",
                                            ].map((item, i) => (
                                    ...
                                    <div className="space-y-6">
                                        {[
                                            ...
                                            },
                                            {
                                                ...
                                                content:
                                                    "Sleek design, smooth ride, and the three-speed settings are perfect for different situations. Love it!",
                                            },
                                            {
                                                name: "James Liu",
                                                avatar: "JL",
                                                ...
                                                content:
                                                    "The matte black finish looks premium and the BMS gives me confidence in battery longevity. Highly recommend!",
                                            },
                                        ].map((review, i) => (
                                    ...
                                    <Accordion type="single" collapsible className="w-full space-y-4">
                                        {[
                                            ...
                                            },
                                            {
                                                ...
                                                answer:
                                                    "Full charge takes 4-5 hours with the included premium fast charger. The smart BMS ensures safe and efficient charging.",
                                            },
                                            {
                                                question: "Is it suitable for hills?",
                                                answer:
                                                    "Yes! The powerful motor handles inclines up to 20% grade. The three-speed settings let you adjust power for different terrains.",
                                            },
                                            {
                                                question: "What about maintenance?",
                                                answer:
                                                    "Minimal maintenance required. The sealed battery and quality components are built to last. We recommend basic checks every 6 months.",
                                            },
                                            {
                                                question: "Is it waterproof?",
                                                answer:
                                                    "The MAVEE Elite has IP54 water resistance rating, suitable for light rain. We recommend avoiding heavy downpours and deep puddles.",
                                            },
                                        ].map((faq, i) => (
                                            <AccordionItem
                                                key={i}
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6">
                            {[
                                { name: "Safety Helmet", price: "$49.99", image: "MAVEE Elite helmet" },
                                { name: "Phone Mount", price: "$29.99", image: "MAVEE Elite phone mount" },
                                { name: "Storage Bag", price: "$39.99", image: "MAVEE Elite storage bag" },
                                { name: "Lock & Cable", price: "$34.99", image: "MAVEE Elite security lock" },
                            ].map((product, i) => (
                                <Card
                                    key={i}
                                ...
                                >
                                    <CardContent className="p-4">
                                        <div className="aspect-square bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl mb-4 overflow-hidden">
                                            <Image
                                                src="https://beasahuotuicaipswzhe.supabase.co/storage/v1/object/public/uploads/c8df79a8-d1a5-4fd7-ac50-65e9e938ca6c.jpg?"
                                                alt={product.image}
                                                width={200}
                                                height={200}
